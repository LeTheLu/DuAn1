...
import com.android.carrental.admin.AdminActivity;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String CREDENTIALS_INCORRECT_MESSAGE2 = "Login with admin";
        ...
        switch (v.getId()) {
            case R.id.btn_login:
                if(loginEmail.getText().toString().equals("admin")&&loginPassword.getText().toString().equals("admin")){
                    openAdminScreen();
                    Toast.makeText(getApplicationContext(), CREDENTIALS_INCORRECT_MESSAGE2, Toast.LENGTH_SHORT).show();
                }else {
                    loginUser();
                }
                break;
